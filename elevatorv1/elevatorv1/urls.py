...
urlpatterns = [
    ...
    path('elevators/<int:elevator_id>/request_floor/', ElevatorViewSet.as_view({'post': 'request_elevator_to_floor'})),
    ...
    path('elevators/hard_reset', ReinitializeElevatorSystemView.as_view({'post': 'hard_reset'})),\
]
